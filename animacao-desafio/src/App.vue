...
export default {
	...
	data() {
		return {
			result: false,
			questionMode: true,
			questions, // é equivalente a questions: questions
			currentQuestions: 0
		}
	},
	methods: {
		...
		nextQuestion() {
			...
			this.currentQuestions = parseInt(r)
...
@keyframes flip-out { /* rotaciona usando os graus */
	from { transform: rotateY(0deg); }
	to { transform: rotateY(90deg); }
}

@keyframes flip-in { /*rotaciona entrando na tela */
